...
UsersSchema.methods.generateHash = function (password) {
    // Adiciona ao objecto UserSchema a 
    // função que gera hashes.

    return bcrypt.hashSync(password, bcrypt.genSaltSync(), null);
    // Devolve uma string com a hash da 
...
var updateUsername = function updateUser(username, profile) {
    return findUser(username, function (err, user) {
        if (!user)
            console.log('Error: User not found!');
        else if (err) {
            console.log('Error: ' + err);
...
var deleteUsername = function deleteUsername(username) {
    return findUser(username, function (err, user) {
        if (!user)
            return console.log('Error: User not found!');
...
// Inicializa a variavel UserList com
...
module.exports = {
    // Ao exportar os objectos estamos a
    ...
    'updateUsername': updateUsername,                                      // Exporta a função updateUsername
    'deleteUsername': deleteUsername,                                       // Exporta a função deleteUsername
};